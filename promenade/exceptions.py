...
class PromenadeException(Exception):
    """
    Base error containing enough information to make a promenade formatted error
    """
    ...
    def __init__(self,
        ...
        :param err_type: If the error is related to the API or CLI
        ...
        self.status = status self.__class__.status

        self.description = description
        self.error_list = massage_error_list(error_list, description)
        self.info_list = info_list
        self.retry = retry
        super().__init__(PromenadeException._gen_ex_message(title,
                                                            description))
