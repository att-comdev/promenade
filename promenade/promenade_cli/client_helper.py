...
class CheckHealth(action.CliAction):
...
class JoinScripts(action.CliAction):
    def __init__(self, api_client, hostname, ip, design_ref, leave_kubectl,
                 dynamic_labels=None, static_labels=None):
        super().__init__(api_client)
...
class Validate(action.CliAction):
