...
function create_manifest {
    sed -i -e 's#$ETCD_INITIAL_CLUSTER_STATE#'$2'#g' /anchor-etcd/{{ .Values.service.name }}.yaml
    sed -i -e 's#$ETCD_INITIAL_CLUSTER#'$1'#g' /anchor-etcd/{{ .Values.service.name }}.yaml
    sed -i -e 's#$ETCD_NAME#'${ETCD_NAME}'#g' /anchor-etcd/{{ .Values.service.name }}.yaml
